...
export default function Journey() {
  ...
  return (
    <Box component="section" sx={{ width: '100%', bgcolor: '#594534', py: { xs: 6, sm: 8, md: 10 } }}>
      <Box sx={{ maxWidth: '64rem', mx: 'auto', px: { xs: 2, sm: 3 } }}>
        {/* Header */}
        <Box sx={{ textAlign: 'center', color: 'white', mb: { xs: 5, sm: 6, md: 8 } }}>
          <Typography variant="h2" sx={{ fontSize: { xs: '1.875rem', sm: '2.25rem', md: '3rem' }, fontWeight: 700, mb: { xs: 1.5, sm: 2 }, fontFamily: 'var(--font-cairo)' }}>
            {t.journey.title}
          </Typography>
          <Typography sx={{ fontSize: { xs: '1rem', sm: '1.125rem' }, color: 'rgba(255, 255, 255, 0.9)', px: 2 }}>
            {t.journey.subtitle}
          </Typography>
        </Box>
